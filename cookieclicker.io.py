#Cookie Clicker, mouse position tr
#written by John Valadez, 4/20/2021
import pygame
...
math.sqrt((mousePos[0]-circX)**2+(mousePos[1]-circY)**2)
...
text1 = font.render('scrore:',False,(0,200,200))
